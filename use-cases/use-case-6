# USE CASE: 6 produce a report on the top N populated countries in the world.
...
As a *Project manager* I want *toproduce a report on the top N populated countries in the world* so that *I see where my project could possibly get the most interaction from.*
